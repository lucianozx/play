...
@WebServlet(urlPatterns = { "/uploadTemp"}, initParams = {
	@WebInitParam(name = "upload_path_linux", value = "/home/ec2-user/static", description = "linux"), 
	@WebInitParam(name = "upload_path", value = "/home/ec2-user/static", description = "windows")
})
...
public class CopyOfFileUploadServlet extends HttpServlet {
	...
	try {
		...
		String uploadDir = "/home/ec2-user/static";
		...
		/*
                ...
                File file = new File(fileUploadPath, part.getName());
